    ...
    public partial class firstmig : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MealPromotions", x => new { x.PromotionId, x.MealId });
                    table.ForeignKey(
                        name: "FK_MealPromotions_Meals_MealId",
                        column: x => x.MealId,
                        principalTable: "Meals",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_MealPromotions_Promotions_PromotionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MealPromotions_MealId",
                table: "MealPromotions",
                column: "MealId");
        }
